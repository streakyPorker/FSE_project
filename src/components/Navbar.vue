  ...
  <nav>
      ...
      <v-dialog v-model="dialog" persistent max-width="490">
        <v-card>
          ...
          <v-card-actions>
            ...
            <v-btn color="success" :disabled="!valid" @click="validate1" class="mr-4">确认</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
      ...
      <v-dialog v-model="dialog2" persistent max-width="490">
        <v-card>
          ...
          <v-card-actions>
            ...
            <v-btn color="success" :disabled="!valid2" @click="validate2" class="mr-4">确认</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
    </v-app-bar>
    <v-navigation-drawer app v-model="drawer" class="primary">
      <v-list shaped class="primary">
        <v-list-item v-for="link in getFilteredLinks" :key="link.text" router :to="link.route">
          <!--依然需要引号-->
          <v-list-item-action>
